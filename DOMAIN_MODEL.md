...
> Companion document to `docs/SPP_CONSTITUTION.md` and part of the SPP Blueprint.
...
| Anti-Corruption Layer | Translates foreign models into SPP language before they touch the domain. | `backend/adapters/*` (Ejar, utilities, platform inbox, Google Apps Script) |
...
*Companion documents:* `docs/SPP_CONSTITUTION.md`, `docs/SPP_ENGINE_VISION.md`, `SPP_BLUEPRINT.md`
