...
| Supporting architecture | System architecture, data architecture, decision engine, operation center, engine vision, merge-gate intent, quality architecture expansions | No — only deepen a scoped concern | No |
