...
| Supporting architecture | System architecture, data architecture, decision engine, engine vision, merge-gate intent, quality architecture expansions | No — only deepen a scoped concern | No |
