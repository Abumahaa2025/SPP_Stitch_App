...
9. Koil layer placement (rules vs understanding vs learning) → Engine Vision.
10. “May we implement yet?” → Architecture Governance §7.
11. Discovered contradiction → record as a gap; propose a resolution; do not silently pick a side.
