...
> Independent companion to `docs/SPP_CONSTITUTION.md` and `DOMAIN_MODEL.md`.
...
| `DOMAIN_MODEL.md` | **What** the system is made of: entities, relationships, lifecycles | Ubiquitous language |
| `SPP_BLUEPRINT.md` (this document) | **How** the system is built: layers, pipelines, engines, integrations | Structural authority |
...
*Independent companion documents:* `docs/SPP_CONSTITUTION.md`, `DOMAIN_MODEL.md`

*Supporting documents:* `docs/SPP_ENGINE_VISION.md`, `docs/MERGE_GATE_PLAN.md`, `backend/docs/DATA_QUALITY.md`
